	...
	public function get_settings_fields(){
		...
		$layout_field = array(
			...
			'enable_login_step' => array(
				'name'=>'enable_login_step', 'label'=>__('Display Login Step', 'woo-multistep-checkout'), 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0, 'hint_text'=>"Enable 'Allow customers to log into an existing account during checkout' under woocommerce Accounts & Privacy settings tab.", 'onchange'=>'thwmscfDisplayLogin(this)',
			),
